...
public class DeckTester
{
    ...
    int[] value1 = {5, 6, 7};
    String[] rank2 = {"Pinapple", "Orange", "Watermelon", "Banana"};
    String[] suit2 = {"Smart", "Adorable", "Nice"};
    int[] value2 = {4, 3, 2, 1};
    String[] rank3 = {"Apple", "Melon", "Strawberry", "Mango", "Kiwi"};
    String[] suit3 = {"Sweet", "Funny", "Amazing", "Perfect"};
